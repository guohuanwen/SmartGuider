...
jlong nativeCreateObject(JNIEnv * jenv, jobject instance, jstring jFileName, jint faceSize)
{
...
void nativeDestroyObject(JNIEnv * jenv, jclass, jlong thiz)
{
...
void nativeStart(JNIEnv * jenv, jclass, jlong thiz)
{
...
void nativeStop(JNIEnv * jenv, jclass, jlong thiz)
{
...
void nativeSetFaceSize(JNIEnv * jenv, jclass, jlong thiz, jint faceSize)
{
...
void nativeDetect(JNIEnv * jenv, jclass, jlong thiz, jlong imageGray, jlong faces)
{
...
static const char* const kClassPathName = "com/bigwen/guider/DetectionBasedTracker";
...
static JNINativeMethod gMethods[] = {
        {"nativeCreateObject", "(Ljava/lang/String;I)J", (jlong*)nativeCreateObject },
...
void JNI_OnUnload(JavaVM* vm, void* reserver) {
